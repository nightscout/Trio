            ...
            List {
                ...
                Section {
                    VStack(alignment: .leading) {
                        ...
                        HStack(alignment: .center) {
                            Text(
                                "Select a vertical chart or horizontal chart to display your Time in Range Statistics."
                            )
                            .font(.footnote)
                            .foregroundColor(.secondary)
                            .lineLimit(nil)
                            ...
                            Button(
                                action: {
                                    ...
                                    selectedVerboseHint =
                                        AnyView(
                                            Text(
                                                "Choose which style for the time in range chart you'd prefer: a vertical/standing bar chart or a horizontal/laying line chart."
                                            )
                                        )
                                    shouldDisplayHint.toggle()
                                },
