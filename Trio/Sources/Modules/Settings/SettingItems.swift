    ...
    static let trioFeaturesItems = [
        ...
        SettingItem(
            ...
            scrollTargetLabels: [
                ...
                "Standard Lower Threshold": "Lower Range Threshold",
                "Extended Lower Threshold": "Lower Range Threshold",
                "Time in Range Type": "Lower Range Threshold",
                "Time in Tight Range (TITR)": "Lower Range Threshold",
                "Time in Normoglycemia (TING)": "Lower Range Threshold",
